...
const heroSlides = [
  {
    ...
    text: "Save big on hand-picked gadgets, fashion, and home essentials. New deals arrive every day.",
  ...
  },
  {
    ...
    title: "Celebrate the",
    accent: "Festive Season",
    action: "Shop festive picks",
    search: "gift",
    theme: "festive",
  },
  {
    badge: "QuicKart Big Days",
    title: "Big Deals.",
    accent: "Bigger Smiles.",
    action: "View big deals",
    search: "electronics",
    theme: "billions",
  },
  {
...
function AppContent() {
  ...
  const [theme, setTheme] = useState(
    () => localStorage.getItem("quickkart-theme") || "dark",
  );
  ...
  return (
    <div
      className={`app-shell theme-${theme} d-flex flex-column min-vh-100 ${theme === "dark" ? "bg-dark text-light" : "bg-light text-dark"}`}
    >
      {/* Top Navigation */}
      <Navbar
      ...
      <main className="flex-grow-1">
        {categoryError && (
          <div className="container mt-3">
            <div className="alert alert-warning mb-0" role="alert">
              Categories could not be loaded. Check that{" "}
              <code>VITE_API_BASE_URL</code> points to the running backend, then
        ...
        {!selectedCategory && !searchTerm && (
          <div className="container mt-4 mb-3">
            <section
              className="hero-carousel shadow-lg"
                ...
                {heroSlides.map((slide) => (
                  ...
                  >
                    <div className="hero-content p-4 p-md-5 text-center text-md-start">
                      <span className="badge hero-badge px-3 py-2 text-uppercase mb-3">
                        {slide.badge}
                      </span>
                      ...
                      <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start">
                        <button
                          ...
                          onClick={() => {
                            ...
                            window.history.pushState(
                              {},
                              "",
                              `${window.location.pathname}?search=${encodeURIComponent(slide.search)}`,
                            );
                          }}
                        >
                          {slide.action}{" "}
                        ...
                        <a
                          href="#catalog"
                          className="btn btn-outline-light rounded-pill px-4 py-2 fw-semibold bg-white"
                        >
                          Browse catalogue
                        </a>
                      </div>
        ...
        <div className="container mb-4">
          <div className="row g-3 text-center">
            <div className="col-md-3 col-6">
              <div className="card bg-white p-3 h-100 d-flex flex-row align-items-center justify-content-center gap-3">
      ...
      {/* Footer */}
      <footer
        className={`${theme === "dark" ? "bg-dark border-secondary" : "bg-white border-light"} border-top mt-5 py-4 text-muted small`}
      >
        <div className="container text-center">
          ...
          <p className="mb-2">
            Empowering seamless online shopping with high-grade security,
            instant checkout, and real-time inventory management.
          </p>
          <div className="text-secondary">
            &copy; {new Date().getFullYear()} QuicKart E-Commerce Inc. All
            Rights Reserved.
          </div>
        </div>
      </footer>
